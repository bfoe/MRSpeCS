...
===================
   ...
   - install included "dcm2nii" tool:
     ...
     you may also try with dcm2nii's 64bit version for this, substitute the 
     first line above with:
         sudo cp dcm2nii64 /usr/local/fsl/bin/dcm2nii
   ...
   - to be able to interactively choose input files "tkinter" is required
     for this download ActiveTcl and follow the installation steps from:
         http://www.activestate.com/activetcl/downloads')
     AppleTcl may also work
   - to be able to read spectro input files in DICOM format "pydicom" is
     required, to install follow the description from:
...
==============
   ...
   - files from FSL "FSLv5.0.9_extract.zip" potentially replacing the need 
     for full FSL installation, also containes dcm2nii.
     usage:
         extract ZIP 
         sudo mv fsl /usr/local
